package com.example.smartcustomview.views.seekbar;
...
import static com.example.smartcustomview.views.seekbar.BubbleSeekBar.TextPosition.BELOW_SECTION_MARK;
import static com.example.smartcustomview.views.seekbar.BubbleSeekBar.TextPosition.BOTTOM_SIDES;
import static com.example.smartcustomview.views.seekbar.BubbleSeekBar.TextPosition.SIDES;
import static com.example.smartcustomview.views.seekbar.BubbleUtils.dp2px;
import static com.example.smartcustomview.views.seekbar.BubbleUtils.sp2px;
...
public class BubbleSeekBar extends SeekBar {
    ...
    public BubbleSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mMax = (int) a.getFloat(R.styleable.BubbleSeekBar_bsb_max, 100.0f);
        ...
        mTrackColor = a.getColor(R.styleable.BubbleSeekBar_bsb_track_color,
                ContextCompat.getColor(context, R.color.text_sport_setting_color));
        mSecondTrackColor = a.getColor(R.styleable.BubbleSeekBar_bsb_second_track_color,
                ContextCompat.getColor(context, R.color.mine_select_color));
        ...
        mDrawableRes = a.getInt (R.styleable.BubbleSeekBar_bsb_thumb_draw,R.drawable.wheel_bg);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int height = mThumbTextSize * 3; // 默认高度为拖动时thumb圆的直径
        if (isShowThumbText) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float yTop = getPaddingTop()+ /*mThumbRadiusOnDragging*/ mThumbRadius;
        ...
        canvas.drawCircle(mThumbCenterX, yTop + 2, /*isThumbOnDragging ? mThumbRadiusOnDragging :*/ mThumbRadius, mPaint);
    }
    ...
    public void setBubProgress(float progress) {
        mProgress = progress;
