...
public class ZIP {
     ...
     * @throws Exception
     */
    public static void UnZipFolder(String zipFileString, String outPathString, ZipResult zipResult) throws Exception {
        ...
        inZip.close();
        if (null != szName) {
            String[] name = szName.split("/");
            if (name.length > 0)
                zipResult.complete(outPathString + File.separator + name[0]);
        }
    }
